...
const TaskTimeline = ({ tasks, centered }: Props) => {
  ...
  return (
    <div className={` w-fit ${centered && "mx-auto"} fade-in-pop h-fit`}>
      {tasks.map((task, i) => (
        <div
          key={i + "." + task.title}
          className="flex items-start justify-start"
        >
          <div className="px-4 py-6 w-[80px] md:w-[120px] text-right relative">
          ...
          <div className="border-l border-zinc-400 max-w-[240px] md:max-w-[560px] py-6 px-4">
